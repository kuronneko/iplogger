                    ...
                    <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                        <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
                            ...
                            <form method="get" class="flex mt-2" @submit.prevent="searchLogger">
                                <jet-input v-model="form.search" id="search" class="w-full" placeholder="Search by IP or HOST"
                                    type="text" />
        ...
        deleteLogger: function (logger) {
            this.$swal({
                ...
                if (result.isConfirmed) {
                    Inertia.delete(route("logger.destroy", logger));
                    this.$swal({
                        position: 'center',
                        color: '#fff',
                        width: 400,
