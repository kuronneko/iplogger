                ...
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
                        ...
                        <form method="get" class="flex mt-2" @submit.prevent="searchLogger">
                            ...
                            <jet-primary-button v-if="form.search" @click="clear()" class="ml-1">
                                    ...
                                    <tbody class="divide-y divide-gray-200">
                                        <tr v-for="logger in loggers.data" :key="logger.id">
                                            ...
                                            "><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                ...
                                                <jet-primary-button @click="showLogger(logger)" class="ml-1">
                                                ...
                                                <jet-danger-button @click="deleteLogger(logger)" class="ml-1">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                        viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                                        class="w-6 h-6">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
